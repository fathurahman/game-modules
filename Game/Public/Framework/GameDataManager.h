...
protected:
	...
	//////////////////////////////////////////////////////////////////////////
	// Sound Bank collection
	//////////////////////////////////////////////////////////////////////////

#if WITH_EDITORONLY_DATA

	/** Should sound bank be automatically collected ? */
	UPROPERTY(EditDefaultsOnly, Category="SoundBank", meta=(DisplayName="AutoCollect"))
	bool bUseSoundBankCollector = true;

	/** Recollect sound banks. */
	UPROPERTY(EditDefaultsOnly, Category="SoundBank", meta=(DisplayName="Recollect", EditCondition="bUseSoundBankCollector"))
	bool bRecollectSoundBanks = false;

#endif

	UPROPERTY(EditDefaultsOnly, Category="SoundBank", meta=(DisplayName="SoundBanks"))
	TArray<TAssetPtr<USoundBank>> SoundBankAssetPtrs;

	mutable TMap<FString, TAssetPtr<USoundBank>> SoundBankAssetPtrMap;
